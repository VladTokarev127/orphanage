					...
					<form action="" class="form__inner">
						...
						<div class="form__checkboxs">
							<div class="form__checkbox">
								...
								<label for="check-1">Я принимаю Условия <a href="#"  class="popup-link" data-popup="popup-offer">договора оферты</a></label>
							</div>
							<div class="form__checkbox">
								<input type="checkbox" name="check-2" id="check-2" required>
								<label for="check-2">Соглашаюсь на обработку моих <a href="#" class="popup-link" data-popup="popup-personality">персональных данных</a></label>
							</div>
						</div>
					</form>
				</div>
